...
public class DAOTest {
	...
	void insertEmployeeTest1() {
		...
		employee.setEmpid(1234567);
		employee.setEmpName("Yashwanth");
		employee.setHcc("hcc");
		employee.setEmailId("masna.yashwanth@gmail.com");
		long time = System.currentTimeMillis();
	...
	void ChangeStatustest() {
		TimeSheetDao ts = new TimeSheetDaoImpl();
		boolean flag = ts.changeStatus(5000);
		assertTrue(flag);
	...
	void getTimeSheetDetails() {
		TimeSheetDao ts = new TimeSheetDaoImpl();
		boolean flag = ts.getTimeSheetDetails(2);
		assertTrue(flag);
